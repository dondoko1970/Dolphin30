...
PCB基板、スイッチプレート、ボトムプレートの「ふち」は、切断面そのままで白っぽくて見映えがあまり良くないので黒のマーカーで塗ることをおすすめします。
...
マイコンのBOOTスイッチのある面を上に向けて、短辺(ピン数=7の辺)2辺に、ピン数6のピンヘッダを出ているピンの'長い側'を差し込み、マスキングテープなどで基板に仮止めします。
